...
function searchUrbanAreas(urbanArea) {
    ...
    urbanData(urbanArea)
        ...
        .then((data) => {
            ...
            //                 areaQualities["Cost of Housing"][
            //                     "Apartment Rent for Large Apartment"
            ...
            //                 areaQualities["Cost of Housing"][
            //                     "Apartment Rent for Medium Apartment"
            //                 ].currency_dollar_value;
            ...
            //                 areaQualities["Cost of Housing"][
            //                     "Apartment Rent for Small Apartment"
            //                 ].currency_dollar_value;
            ...
            //                 areaQualities["Cost of Housing"]["Rent Index Telescore"]
            //                     ?.float_value || "test";
            ...
            //                 areaQualities["Cost of Living"]["Consumer Price Index"]
            //                     .float_value;
            ...
            //                 areaQualities["Economy"]["GDP Per Capita"]
            //                     .currency_dollar_value;
            //             $("#GDPPerCapita").text(`
            ...
            //             var pisaRankingVal =
            //                 areaQualities["Education"]["PISA Ranking"].int_value; //PISA Ranking
            //             $("#pisaRanking").text(`
            //     PISA Ranking: ${pisaRankingVal}`);

            //             var pisaRankingTelescoreVal = //PISA Ranking Telescore
            //                 areaQualities["Education"]["PISA Ranking Telescore"]
            //                     .float_value;
            ...
            //             var qualityVal =
            //                 areaQualities["Health Care"]["Quality"].float_value; //Quality
            //             $("#Quality").text(`
            ...
            //             var cleanlinessVal =
            //                 areaQualities["Pollution"]["Cleanliness"].float_value; //Cleanliness
            //             $("#cleanliness").text(`
            ...
            //             //Safety
            //             var crimeRateVal =
            //                 areaQualities["Safety"]["Crime Rate"].float_value; //Crime Rate
            //             $("#crimeRate").text(`
            ...
            //             //Taxation
            //             var incomeTaxVal =
            //                 areaQualities["Taxation"]["Income Tax"].float_value; //Income Tax
            //             $("#incomeTax").text(`
            // Income Tax: ${incomeTaxVal}`);

            //             var salesTaxVal =
            //                 areaQualities["Taxation"]["Sales Tax"].percent_value || "test"; //Sales Tax
            //             $("#salesTax").text(`
